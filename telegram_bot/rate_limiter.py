"""
Rate limiting and abuse prevention for Aptos Trading Bot
Prevents spam and ensures fair usage for Aptos trading operations
"""
import time
import logging
...
class RateLimiter:
    """
    Multi-level rate limiting system for Aptos trading bot
    """
...
"""
Rate limiting for Aptos bot commands
"""
import asyncio
import time
from collections import defaultdict, deque
...
class RateLimiter:
    """Rate limiting for Aptos bot commands to prevent abuse"""
